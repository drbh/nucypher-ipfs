...
# backup hash - should be blank
ipfs_hash = "QmSUsXhtxzFPTvAM79FNYTWfHaPADxhCS4gHuWqzDZnjxR"
print()
print("🚀 FETCHING FROM IPFS D-STORAGE NETWORK 🚀")
if len(sys.argv) > 1:
    ipfs_hash = sys.argv[1]
    print("Accessing File:\t%s" % ipfs_hash)


dat = ipfs_gateway_api.cat(ipfs_hash)
